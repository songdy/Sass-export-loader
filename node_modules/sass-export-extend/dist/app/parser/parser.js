...
const DECLARATION_PATTERN = `\\$['"]?(${VARIABLE_PATERN})['"]?\\s*:\\s*(${VALUE_PATERN})(?:\\s*!(global|default)\\s*;|\\s*;(?![^\\{]*\\}))\\s*(${ANNOTATION_PATERN})?`;
...
class Parser {
    ...
    parseSingleDeclaration(matchDeclaration) {
        ...
        return Object.assign({ name, value }, extendFields);
    }
